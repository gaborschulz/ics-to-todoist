...
REMINDER_TIMES = [reminder_struct(hour=0, minute=0, dayoffset=0, houroffset=-1, minuteoffset=0)]
...
def add_task(api: TodoistAPI, task_name: str, due: datetime, project_id: int, auto_reminder: bool, notes: list):
